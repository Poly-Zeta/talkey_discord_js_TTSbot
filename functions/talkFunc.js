...
async function talkToLlamaFunc(interaction,readTxt, guildId, textChannel, botConnection, nickname,uid,doMoldProcessFlg) {
    ...
    await addLlamaQueue(interaction,guildId, nickname, readTxt, uid,textChannel,botConnection,doMoldProcessFlg);
